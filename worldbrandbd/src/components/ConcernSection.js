...
const ConcernSection = ({ category_section }) => {
  return (
    <div className="relative section">
      ...
      >
        {category_section?.bottom_category_section?.section_category_list
          ?.length > 0 &&
          category_section?.bottom_category_section?.section_category_list?.map(
            (item, index) => (
              <SwiperSlide key={index}>
                ...
                >
                  <div className="grid items-center justify-center">
                    <div className="my-2 relative w-[200px] lg:w-[170px]  h-[160px] xs:w-[100px] xs:h-[80px] xms:w-[100px] xms:h-[90px] xls:w-[100px] xls:h-[100px] sm:w-[110px] sm:h-[100px] md:w-[150px] md:h-[110px]">
                      <Image
