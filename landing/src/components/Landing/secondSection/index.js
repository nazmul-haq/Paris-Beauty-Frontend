      ...
      <div>
        <div className="max-w-7xl mx-auto bg-gradient-to-b from-primary-100 via-primary-300 to-primary-500 px-6 rounded-md">
          <div className="flex items-center justify-center pt-[50px] ">
              ...
              <div className="bg-[#b08020] px-4 py-2 text-[26px] font-bold text-white rounded-3xl xs:text-[20px] xms:text-[20px] xls:text-[20px] sm:text-[22px]">
                {titleRes?.title}
              </div>
          ...
          <div className=" py-3">
            ...
            >
              <button className=" px-10 py-2 my-5 rounded-lg text-xl font-bold text-white bg-[#FC7F01]  transition duration-300 transform hover:scale-90 flex items-center">
                {" "}
                <span className="pr-2">
