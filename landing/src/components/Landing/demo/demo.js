    ...
    let obj = {
      ...
      grand_total:
        type == 1
          ...
          : type == 2
          ? Number(Number(total) - (Number(total) * Number(promoValue)) / 100 + shippingCost)
                ...
                <div className="grid grid-cols-2 gap-14 px-5 xs:px-2 xs:grid-cols-1 xms:px-2 xms:grid-cols-1 xls:px-2 xls:grid-cols-1 sm:px-2 sm:grid-cols-1">
                  ...
                  <div className="col-span-1">
                    ...
                    <div className="bg-white px-4 py-6 rounded-lg">
                      ...
                      <div className="text-[18px] bg-[#FC7F01] py-2 px-2 mt-3 text-white">
                    ...
                    <button
                      type="submit"
                      className="bg-[#FC7F01] flex items-center justify-center py-2 rounded-3xl mb-5 w-full"
                    >
