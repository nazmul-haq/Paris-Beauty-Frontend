          ...
          <div className="w-full min-h-[500px]">
            ...
            <div className="flex items-center justify-center py-[40px]">
              <button
                ...
                className="border-2 border-white px-10 py-2 rounded-lg text-xl font-bold text-white bg-primary-500  transition duration-300 transform hover:scale-90 flex items-center"
              >
                {" "}
                <span className="pr-2">
